export default {
  ...
  nav: {
    ...
    sectionPlanning: '🏭 Kế Hoạch SX (生管部) V1.1',
    orderControl: '① Quản Chế Đơn & Trạng Thái',
    materialAnalysis: '② Phân Tích NVL Từng Đơn',
    deliveryConfirm: '③ Xác Nhận Giao Kỳ',
    productionOrderIssue: '④ Lệnh Sản Xuất',
  ...
  pageTitles: {
    ...
    '/rd/bom': 'Quản Lý BOM',
    '/planning/order-control': 'Quản Chế Đơn & Trạng Thái Order',
    '/planning/material-analysis': 'Phân Tích NVL Từng Đơn Hàng',
    '/planning/delivery-confirm': 'Xác Nhận Giao Kỳ Liên Phòng Ban',
    '/planning/production-order': 'Lệnh Sản Xuất – Phát Hành Xuống Xưởng',
